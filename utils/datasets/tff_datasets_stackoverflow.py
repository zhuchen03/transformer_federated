...
def load_data(cache_dir=None):
  ...
  # Copying datapath rules from Keras. Skip extracting the data if we did not really download it.
  fname = 'stackoverflow.tar.bz2'
...
def load_word_counts(cache_dir=None):
  ...
  """
  fname = 'stackoverflow.word_count.tar.bz2'
